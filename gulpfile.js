...
const gulpif = require('gulp-if'); // вызывает функции по условию
const notify = require('gulp-notify');
const image = require('gulp-imagemin');
const pugIncludeGlob = require('pug-include-glob'); // позволяет использовать /**/*.pug конструкцию
...
const paths = {
  ...
  srcPartsFolder: `${srcFolder}/partials`,
  srcPartialsFolder: `${srcFolder}/partials`,
  srcPagesFolder: `${srcFolder}/pages`,
  resourcesFolder: `${srcFolder}/resources`,
  jsonData: `${srcFolder}/pug/data`,
  srcScssPugFolder: `${srcFolder}/pug/components/**/*.scss`
};

let isProd = false; // dev by default

// const cleanHtml = () => {
//   return del([`${srcFolder}/**/*.html`])
// }
const clean = () => {
  // cleanHtml()
...
const getData = () => {
  const dir = paths.jsonData // здесь ищем json файлы
...
const watchFiles = () => {
  ...
  watch([paths.srcScssPugFolder, paths.srcScss], styles);
  // watch(paths.srcScss, styles);
  watch(paths.srcFullJs, scripts);
  // watch(`${paths.srcPartialsFolder}/*.pug`, pug);
...
exports.pages = pug;
exports.default = series(clean, pug, scripts, styles, resources, images, webpImages, svgSprites, watchFiles);

exports.backend = series(clean, pug, scriptsBackend, stylesBackend, resources, images, webpImages, svgSprites);

exports.build = series(toProd, clean, pug, scripts, styles, resources, images, webpImages, svgSprites, htmlMinify);
